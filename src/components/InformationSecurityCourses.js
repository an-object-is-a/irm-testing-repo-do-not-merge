...
const InformationSecurityCourses = () => {
  /*
    Getting all Wordpress blog posts with the 'category' of "InformationSecurity".
  */
  const data = useStaticQuery(graphql`
    query InformationSecurityCourses {
      allWpPost(
        filter: {categories: {nodes: {elemMatch: {name: {eq: "InformationSecurity"}}}}}
      ) {
        edges {
          node {
            title
...
export default InformationSecurityCourses;