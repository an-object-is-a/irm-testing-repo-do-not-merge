...
const ContinuityResilienceRecoveryCourses = () => {
  /*
   Getting all Wordpress blog posts with the 'category' of "continuityresiliencerecovery".
  */
  const data = useStaticQuery(graphql`
    query ContinuityResilienceRecoveryCourses {
      allWpPost(
        filter: {categories: {nodes: {elemMatch: {name: {eq: "continuityresiliencerecovery"}}}}}
      ) {
        edges {
          node {
            title
...
export default ContinuityResilienceRecoveryCourses;