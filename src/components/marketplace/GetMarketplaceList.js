...
const GetMarketplaceList = ({ marketplace_data }) => {
  /* Destructuring the 'edges' array and renaming it, 'query_result', out of the passed down WP Query.
    This is the equivalent of:
      const query_return = useStaticQuery(graphql``);
      const query_result = query_return.allWpPost.edges;
  */
  const { allWpPost: { edges: query_result } } = marketplace_data;
