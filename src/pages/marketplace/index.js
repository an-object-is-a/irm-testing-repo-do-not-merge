...
const AllMarketplaceList = loadable(() => import('../../components/marketplace/AllMarketplaceList'));
const Slide = loadable(() => import('react-reveal/Slide'));

/*
  The main marketplace landing page listing all marketplace products.
  This is the only marketplace product listing page that doesn't get auto-generated by Gatsby.
  To view how the other pages get generated, see files: 'gatsby-node.js' & 'marketplace-listing.js'
*/
const Marketplace = () => {
  return (
    <Layout pageTitle="Marketplace | IRM Consulting & Advisory">
      <Helmet>
        <meta charSet="UTF-8" />
        <meta name="description" content="IRM Consulting & Advisory - Marketplace | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
        ...
        <meta property="og:description" content="IRM Consulting & Advisory - Marketplace | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
        ...
        <meta property="twitter:description" content="IRM Consulting & Advisory - Marketplace | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="content-box">
                <h1>IRM Consulting & Advisory <br /> Marketplace</h1>
                <p></p>
              </div>
            </div>
          </div>
