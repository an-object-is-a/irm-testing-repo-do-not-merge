...
const MarketplaceSecurity = () => {
  ...
  return (
    <StaticQuery
      query={graphql`
        query MarketplaceSecurity {
          allWpPost(
            filter: {categories: {nodes: {elemMatch: {name: {in: "Security Mis-Configuration"}}}}}
          ) {
            edges {
              node {
                title
          ...
          <>
            <div className="col-12">
              <MarketplaceOptions
                ...
                heading={"Security Mis-Configuration"}
              />
            </div>
