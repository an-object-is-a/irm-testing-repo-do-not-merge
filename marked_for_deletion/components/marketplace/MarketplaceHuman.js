...
const MarketplaceHuman = () => {
  ...
  return (
    <StaticQuery
      query={graphql`
        query MarketplaceHuman {
          allWpPost(
            filter: {categories: {nodes: {elemMatch: {name: {in: "Human Security Awareness"}}}}}
          ) {
            edges {
              node {
                title
          ...
          <>
            <div className="col-12">
              <MarketplaceOptions
                ...
                heading={"Human Security Awareness"}
              />
            </div>
...
export default MarketplaceHuman;
