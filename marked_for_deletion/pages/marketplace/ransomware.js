...
const MarketplaceRansomware = loadable(() => import('../../components/marketplace/MarketplaceRansomware'));
const Slide = loadable(() => import('react-reveal/Slide'));

const Ransomware = () => (
  <Layout pageTitle="Ransomware | IRM Consulting & Advisory">
    <Helmet>
      <meta charSet="UTF-8" />
      <meta name="description" content="IRM Consulting & Advisory - Ransomware Awareness | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="content-box">
              <h1>IRM Consulting & Advisory <br /> Ransomware Awareness</h1>
              <p></p>
            </div>
          </div>
        </div>
