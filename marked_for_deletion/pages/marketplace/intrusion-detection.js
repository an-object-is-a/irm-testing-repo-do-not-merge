...
const MarketplaceIntrusion = loadable(() => import('../../components/marketplace/MarketplaceIntrusion'));
const Slide = loadable(() => import('react-reveal/Slide'))

const IntrusionDetection = () => (
  <Layout pageTitle="Intrusion Detection | IRM Consulting & Advisory">
    <Helmet>
      <meta charSet="UTF-8" />
      <meta name="description" content="IRM Consulting & Advisory - Security Intrusion Detection | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
      ...
      <meta property="og:url" content="https://elated-swanson-224ee1.netlify.app/marketplace/intrusion-detection/" />
      <meta property="og:title" content="IRM Consulting & Advisory - Cybersecurity Consulting for your SaaS Business" />
      <meta property="og:description" content="IRM Consulting & Advisory - Security Intrusion Detection | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
      ...
      <meta property="twitter:description" content="IRM Consulting & Advisory - Security Intrusion Detection | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
      ...
      <link rel="canonical" href="https://elated-swanson-224ee1.netlify.app/marketplace/intrusion-detection/" />
    </Helmet>
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="content-box">
              <h1>IRM Consulting & Advisory <br /> Security Intrusion Detection</h1>
              <p></p>
            </div>
          </div>
        </div>
