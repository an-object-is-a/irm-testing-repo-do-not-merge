...
const MarketplacePassword = loadable(() => import('../../components/marketplace/MarketplacePassword'));
const Slide = loadable(() => import('react-reveal/Slide'))

const Password = () => (
  <Layout pageTitle="Password | IRM Consulting & Advisory">
    <Helmet>
      <meta charSet="UTF-8" />
      <meta name="description" content="IRM Consulting & Advisory - Password Management | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
      ...
      <meta property="og:url" content="https://elated-swanson-224ee1.netlify.app/marketplace/password/" />
      <meta property="og:title" content="IRM Consulting & Advisory - Cybersecurity Consulting for your SaaS Business" />
      <meta property="og:description" content="IRM Consulting & Advisory - Password Management | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
      ...
      <meta property="twitter:description" content="IRM Consulting & Advisory - Password Management | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
      ...
      <link rel="canonical" href="https://elated-swanson-224ee1.netlify.app/marketplace/password/" />
    </Helmet>
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="content-box">
              <h1>IRM Consulting & Advisory <br /> Password Management</h1>
              <p></p>
            </div>
          </div>
        </div>
