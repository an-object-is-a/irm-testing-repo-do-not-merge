...
const MarketplaceEndpoint = loadable(() => import('../../components/marketplace/MarketplaceEndpoint'));
const Slide = loadable(() => import('react-reveal/Slide'));

const EndpointSecurity = () => (
  <Layout pageTitle="Endpoint Security | IRM Consulting & Advisory">
    <Helmet>
      <meta charSet="UTF-8" />
      <meta name="description" content="IRM Consulting & Advisory - Endpoint Security | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
      ...
      <meta property="og:url" content="https://elated-swanson-224ee1.netlify.app/marketplace/endpoint-security/" />
      <meta property="og:title" content="IRM Consulting & Advisory - Cybersecurity Consulting for your SaaS Business" />
      <meta property="og:description" content="IRM Consulting & Advisory - Endpoint Security | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
      ...
      <meta property="twitter:description" content="IRM Consulting & Advisory - Endpoint Security | Explore our Marketplace for FREE Security Solutions and Tools for your Business" />
      ...
      <link rel="canonical" href="https://elated-swanson-224ee1.netlify.app/marketplace/endpoint-security/" />
    </Helmet>
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="content-box">
              <h1>IRM Consulting & Advisory <br /> Endpoint Security</h1>
              <p></p>
            </div>
          </div>
        </div>
